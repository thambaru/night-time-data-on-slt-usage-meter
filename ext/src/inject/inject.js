    ...
    var readyStateCheckInterval = setInterval(function () {
        if (document.readyState === "complete") {
            ...
            if (!(isNaN(totalUsed) || isNaN(totalAll) || isNaN(standardUsed) || isNaN(standardAll))) {
                ...
                $('#tnwsltntd-container').html("<div class='col-lg-12 col-md-12'><div class='sc-kgAjT kziELt'><div class='inner-node'><h6 class='sc-dnqmqq hZAKPK'>Night Data</h6><div style='margin-top: 10px;'></div><div style='position: relative;'><svg width='180' height='180' viewBox='-25 -25 400 400'><circle stroke='rgba(20,128,225,0.2)' cx='175' cy='175' r='175' stroke-width='40' fill='none'></circle><circle stroke='#2597D8' transform='rotate(-90 175 175)' cx='175' cy='175' r='175' stroke-dasharray='1100' stroke-width='40' stroke-dashoffset='1100' stroke-linecap='butt' fill='none' style='stroke-dashoffset:" + nightRemainingPercentage + " '; transition: stroke-dashoffset 1s ease-out 0s;'></circle><text fill='#2597D8' x='50%' y='46%' dx='-25' text-anchor='middle' class='remaining-int'>" + nightRemainingPercentage + "<tspan dx='10'>%</tspan></text></svg><p class='remaining-text'>Remaining</p></div><div style='margin-top: -40px;'><h6 id='tnwsltntd-text' class='sc-dnqmqq jZsdgY'>Night Time: Please refresh the page</h6><p style='font-size: 12px; margin: 0px; font-weight: 600; color: rgba(255, 95, 88, 0.9);'><em>"+validTill+"</em></p></div></div></div></div>");
